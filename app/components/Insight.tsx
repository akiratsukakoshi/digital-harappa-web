    ...
    return (
        <section className="py-24 bg-gray-50">
            <div className="max-w-4xl mx-auto px-6 text-center">
                <h2 className="text-sm font-bold text-orange-500 tracking-widest uppercase mb-4">Insight</h2>
                <h3 className="text-3xl md:text-5xl font-bold mb-12 text-gray-900 leading-tight">
                    なぜ今、あなたがやるのか
                </h3>
